...
const HeaderLeft = () => {
  return (
    <div className="md:flex-[1] ">
      ...
      <div className="min-h-screen top-0 hidden md:sticky md:flex items-center justify-center bg-teal-500 text-white"> 
        <ul className="flex flex-col gap-10">
          {["home", "experience", "projects", "contact"].map((item) => (
            ...
            >
              ...
              -translate-x-5 opacity-0 transform transition-all duration-200 group-hover:opactiy-100 group-hover:translate-x-0
              "/>
      ...
      z-10 flex justify-evenly bg-teal-600 p-5 text-white md:hidden">
